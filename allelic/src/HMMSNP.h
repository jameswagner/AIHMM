...
public:
    ...
    virtual ~HMMSNP();
    void baumWelch(std::vector<Individual*>& individuals, const std::string& outputFile);
    void leftToRight(std::vector<Individual*>& individuals, const std::string outputFileName, double weight);
...
private:
    ...
    void initializeTransitionValues(std::vector<Individual*>& individuals, std::vector<std::vector<std::vector<std::vector<double>>>>& tempTransitionValues);
    void perChromosomeSet(std::vector<Individual*>& individuals, std::vector<std::vector<int>>& maxStates, std::vector<std::vector<std::vector<std::vector<double>>>>& tempTransitionValues, std::vector<std::vector<float>>& iarray, int chromosomeIndex);
    void setEmissionProbabilities(std::vector<Individual*>& individuals, std::vector<std::vector<double>>& emissionProbabilities, 
    ...
    void backward(std::vector<Individual*>& individuals, std::vector<std::vector<double>>& betas, std::vector<double>& scales, std::vector<std::vector<std::vector<double>>>& transitionsLocal, std::vector<std::vector<double>>& emissionProbabilities, int size, int individualIndex, std::vector<ExpressionInfo*>& expressionSuperVector);
    ...
    void fileOutput(std::vector<Individual*>& individuals, std::ofstream& myViterbiFile, std::ofstream& myfile, int chromosomeIndex, std::vector<ExpressionInfo*>& expressionSuperVector, std::vector<std::vector<float>>& iarray, std::vector<std::vector<int>>& maxStates, int individualIndex, const std::string& fileName);
